...
var generateExpression = function(astNode, omitIndentation) {
    switch(astNode.type) {
        ...
        case 'binop':
            ...
            if(astNode.op === '.') {
                print('anglRuntime.resolveObjectBeforeDot(');
        ...
        case 'funccall':
            ...
            if(astNode.isMethodCall) {
                ...
                generateExpression({
                    type: 'identifier',
                    variable: astUtils.getAnglScope().getVariableByIdentifierInChain('self')
                });
            } else {
                ...
                generateExpression({
                    type: 'identifier',
                    variable: astUtils.getAnglScope().getVariableByIdentifierInChain('other')
                })
            }

...
// TODO all emitted code should "use strict"
...
var generateExpression = function(astNode) {
    switch(astNode.type) {
        ...
        case 'string':
            ...
            // Two characters are valid in JSON strings but not Javascript strings:
            // line separator and page separator (\u2028 and \u2029)
            print(')');
            break;
...
var generateStatement = function(astNode, omitTerminator, omitIndentation) {
    ...
    switch(astNode.type) {
        ...
        case 'break':
            ...
            // Also, will we ever emit code where we're inside a loop in the JS code that doesn't exist in the Angl code?
            // If so, we can try making use of labels to break out of multiple loops at once.
            break;
